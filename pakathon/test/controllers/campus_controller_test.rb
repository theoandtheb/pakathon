...
class CampusControllerTest < ActionController::TestCase
  ...
  test "should create campu" do
    assert_difference('Campu.count') do
      post :create, campu: { address: @campu.address, latitude: @campu.latitude, longitude: @campu.longitude, name: @campu.name }
    end
  ...
  test "should update campu" do
    patch :update, id: @campu, campu: { address: @campu.address, latitude: @campu.latitude, longitude: @campu.longitude, name: @campu.name }
    assert_redirected_to campu_path(assigns(:campu))
  end
